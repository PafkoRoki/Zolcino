...
function openModal(target) {
  ...
  const regionFunction = target.getAttribute("region-function") || "Brak informacji";
  const area = target.getAttribute("data-area") || "Brak informacji";
  const building = target.getAttribute("data-building") || "Brak informacji";
  const quarter = target.getAttribute("data-quarter") || "Brak informacji";
  const pum = target.getAttribute("data-pum") || "Brak informacji";
  const pumk = target.getAttribute("data-pumk") || "Brak informacji";
  const price = target.getAttribute("data-price") || "Brak informacji";
